...
def construct_blueprint(datastore: ChangeDetectionStore):
    ...
    def browsersteps_start_session():
        ...
        #print("\n\t\t IN browser steps blueprint \n\n\n")
        #import pdb; pdb.set_trace();
        # if I'm right, on create the browser (or Flask blueprint)
        # should generate a uuid that's tacked on to the GET request
        #
        # and is copied to the request object
...
def start_browsersteps_session(watch_uuid):
    ...
    # We remove use of the datastore until we actually need it and assume we do 
    # not use proxies
    proxy = None
    # proxy_id = datastore.get_preferred_proxy_for_watch(uuid=watch_uuid)
    # proxy = None
